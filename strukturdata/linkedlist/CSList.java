...
public class CSList {
    ...
    public static void main(String arg[]){
        CSList.insertKeretaAwal(30);
        CSList.insertKeretaAwal(610);
        CSList.insertKeretaAwal(640);
        CSList.insertKeretaAwal(602);
        CSList.insertKeretaAwal(601);
        CSList.insertKeretaAwal(60);
        CSList.insertKeretaAwal(50);
        CSList.insertKeretaAkhir(89);
        CSList.cetakKereta();
        CSList.deleteKeretaAwal();
        CSList.cetakKereta();
        //LatihanList.deleteKeretaAkhir();
        Object o[]=CSList.cariPosisiKereta(60);
        CSList.cetakHasilPencarian(o);
        CSList.menggantiKereta(601, 300);
        CSList.cetakKereta();
        CSList.deleteKeretaYangdiCari(50);
        CSList.cetakKereta();
    }
}
