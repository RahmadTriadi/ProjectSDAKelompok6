...
import strukturdata.linkedlist.CSList;
 ...
 * @author juna
 */
public class RunAntrianCS implements Runnable{
    private final Thread tt;
    JTable table2, table3;
    public boolean kendaliRun=true;
    public RunAntrianCS(JTable table2,JTable table3){
        tt=new Thread(this);
        tt.start();
        this.table2=table2;
        this.table3=table3;
        ...
        while(kendaliRun){
            ...
            try {
                ...
                while(j<table3.getRowCount()){
                    ...
                    String status="";
                int [] value=CSList.cariPrioritas();
                ...
                for(int i=0;i<m.getRowCount();i++){
                    ...
                    if(value[1]==Integer.parseInt(
                       ...
                       // Thread t=new Thread();
                        ...
                        m.removeRow(i);
                        CSList.deleteKeretaPrioritas(value[0]);
                        CSList.cetakAntrianTeller();
                    }
                }
